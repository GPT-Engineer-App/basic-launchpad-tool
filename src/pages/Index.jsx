  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      <header className="bg-primary text-primary-foreground p-4">
        <h1 className="text-2xl font-bold">My Error-Prone App</h1>
      </header>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-card p-6 rounded-lg shadow-md mb-8">
          <h3 className="text-2xl font-semibold mb-4">Error-Prone Counter</h3>
          <p className="mb-4 text-xl">Current Count: <span className="font-bold text-primary">{count}</span></p>
          <div className="flex space-x-4">
            <Button onClick={incrementWithError} variant="default">Increment (Error at 5)</Button>
        ...
        <div className="bg-muted p-6 rounded-lg">
          ...
          <Button variant="link" onClick={() => alert("Be careful with that increment button!")}>Learn More</Button>
        </div>
      </main>

      <footer className="bg-secondary text-secondary-foreground p-4 text-center">
        <p>&copy; {new Date().getFullYear()} My Error-Prone React App. Use at your own risk!</p>
      </footer>
    </div>
  );
};
